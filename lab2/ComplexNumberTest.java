...
class ComplexNumber<T extends Number, U extends Number> implements Comparable<ComplexNumber<T, U>>{
    ...
    public double modul(){
        return Math.sqrt(Math.pow(t.doubleValue(), 2) + Math.pow(u.doubleValue(), 2));
    }
    ...
    public String toString(){
        if(u.doubleValue() >= 0){
            return String.format("%.2f", t.doubleValue()) + "+" + String.format("%.2f", u.doubleValue()) + "i";
        }
        return String.format("%.2f", t.doubleValue()) + String.format("%.2f", u.doubleValue()) + "i";
    }
